...
} from "../apps/api/dist/src/services/audit/algorithmicTraceability.js";
...
console.log(
  `   Active model: ${initResult.activeModelVersion?.modelType} ${initResult.activeModelVersion?.version}`,
);
