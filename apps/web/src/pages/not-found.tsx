...
export default function NotFound() {
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-[#0a0f1e] relative overflow-hidden">
      {/* Background effects */}
      <div className="absolute top-1/4 left-1/4 w-[500px] h-[500px] rounded-full bg-orange-600/8 blur-[120px] pointer-events-none" />
      <div className="absolute bottom-1/4 right-1/4 w-[300px] h-[300px] rounded-full bg-orange-600/8 blur-[80px] pointer-events-none" />

      <div className="relative text-center px-4 max-w-lg mx-auto">
        {/* Brand */}
        <div className="text-2xl font-bold text-orange-500 tracking-wider mb-8">CODA</div>
        ...
        <Link href="/">
          <Button
            size="lg"
            className="bg-orange-600 hover:bg-orange-500 text-white font-semibold px-8 h-11 shadow-lg shadow-orange-600/20 transition-all"
          >
