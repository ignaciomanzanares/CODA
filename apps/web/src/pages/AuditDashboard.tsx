                ...
                <div className="flex gap-4 text-xs">
                  {activeModel.trainingMetrics.auc && (
                    <span className="text-slate-700">
                      AUC: <span className="font-mono font-semibold">{activeModel.trainingMetrics.auc.toFixed(3)}</span>
                    </span>
                  )}
                  {activeModel.trainingMetrics.gini && (
                    <span className="text-slate-700">
                      Gini: <span className="font-mono font-semibold">{activeModel.trainingMetrics.gini.toFixed(3)}</span>
                    </span>
                  )}
                </div>
              </div>
