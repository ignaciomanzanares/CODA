            ...
            <Card className="hover:shadow-md transition-shadow cursor-pointer h-full">
              ...
              <CardContent className="space-y-2 text-sm">
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">{formatCurrency(company.summary?.cashBalance ?? 0)}</span>
                </div>
                <div className="flex justify-between">
  ...
  return (
    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
      <Card>
        ...
        <CardContent>
          <p className="text-2xl font-bold">{formatCurrency(m.revenue)}</p>
        </CardContent>
      </Card>
      <Card>
        <CardHeader className="flex flex-row items-center justify-between pb-2">
        ...
        <CardContent>
          <p className="text-2xl font-bold">{formatCurrency(m.expenses)}</p>
        </CardContent>
      </Card>
      <Card>
        <CardHeader className="flex flex-row items-center justify-between pb-2">
        ...
        <CardContent>
          <p className="text-2xl font-bold">{formatCurrency(m.cashBalance)}</p>
        </CardContent>
      </Card>
      <Card>
        <CardHeader className="flex flex-row items-center justify-between pb-2">
