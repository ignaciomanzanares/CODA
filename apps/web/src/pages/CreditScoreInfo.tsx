    ...
    <div className="w-full">
      <div className="flex h-6 rounded-full overflow-hidden">
        {zones.map((z, i) => {
          ...
          return <div key={i} className={`${z.color} h-full`} style={{ width: `${width}%` }} />;
        })}
      </div>
    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-orange-100 leading-relaxed">
              CODA calcula dos scores complementarios para darte una imagen completa de tu situación
              financiera.
            </p>
          </div>
        </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-gray-600 text-lg leading-relaxed space-y-4 mb-8">
              <p>
                ...
                industria bancaria conoce: historial de obligaciones, comportamiento de pago,
                niveles de endeudamiento y capacidad de repago. Construido con técnicas de machine
                learning supervisado, este score es directamente comparable con los estándares de
                evaluación crediticia en Chile.
              </p>
              <p className="font-medium text-gray-800">
                ¿Para qué sirve? Para entender cómo te ven los bancos y las instituciones
                financieras hoy.
              </p>
            </div>
            ...
            <div className="mt-8 space-y-4">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <FactorRow
                  weight="35%"
                  title="Historial CMF"
                  desc="Obligaciones vigentes, mora y comportamiento de pago registrado en la CMF."
                />
                <FactorRow
                  weight="30%"
                  title="Endeudamiento"
                  desc="Relación deuda-ingreso, concentración por tipo de crédito y carga financiera total."
                />
                <FactorRow
                  weight="20%"
                  title="Comportamiento transaccional"
                  desc="Patrones de gasto, estabilidad de ingresos y uso del flujo de caja."
                />
                <FactorRow
                  weight="15%"
                  title="Capacidad de pago"
                  desc="Ingreso disponible después de gastos fijos y compromisos financieros."
                />
              </div>
            </div>
          </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-gray-600 text-lg leading-relaxed space-y-4 mb-8">
              <p>
                ...
                miden: estabilidad de tus ingresos, volatilidad de tu flujo mensual, liquidez
                residual después de gastos fijos, ratio de gastos discrecionales y señales tempranas
            ...
            <div className="mt-8 space-y-4">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <FactorRow
                  weight="25%"
                  title="Liquidez"
                  desc="Saldo disponible promedio en relación a gastos fijos mensuales."
                />
                <FactorRow
                  weight="20%"
                  title="Estabilidad de ingresos"
                  desc="Variabilidad mes a mes de tus ingresos: a menor volatilidad, mejor score."
                />
                <FactorRow
                  weight="20%"
                  title="Gastos fijos"
                  desc="Proporción de ingresos comprometida en gastos recurrentes y obligaciones."
                />
                <FactorRow
                  weight="20%"
                  title="Días críticos"
                  desc="Número de días con saldo por debajo de un umbral mínimo de seguridad."
                />
                <FactorRow
                  weight="15%"
                  title="Tendencia"
                  desc="Dirección general de tu flujo de caja: ¿estás mejorando o deteriorándote?"
                />
              </div>
            </div>
          </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-gray-600 text-lg leading-relaxed space-y-4 mb-8">
              <p>
                ...
                estás según el sistema. El score transaccional dice cómo te estás comportando
                realmente.
              </p>
              <p>
      ...
      <section className="py-20 bg-orange-600 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Conoce tu score real</h2>
