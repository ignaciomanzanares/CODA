...
const colorMap = {
  ...
  purple: "bg-violet-50 text-violet-600 dark:bg-violet-500/10 dark:text-violet-400 border-violet-100 dark:border-violet-500/20",
  ...
  slate: "bg-slate-100 text-slate-600 dark:bg-slate-500/10 dark:text-slate-400 border-slate-200 dark:border-slate-500/20",
...
export function PastelIcon({ icon: Icon, color = "blue", size = "md", className }: PastelIconProps) {
  const s = sizes[size];
  return (
    <div className={cn(s.box, "border flex items-center justify-center shrink-0", colorMap[color], className)}>
