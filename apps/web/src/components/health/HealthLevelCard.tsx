...
export default function HealthLevelCard({ nivel, nivelNombre, salida, scoreCompuesto, descripcionNivel }: HealthLevelCardProps) {
      ...
      <CardContent>
        <div className="flex gap-6 items-start">
          ...
          <div className="flex-1">
            <div className="mb-1 text-sm text-gray-500">Nivel {nivel > 0 ? `+${nivel}` : nivel}</div>
