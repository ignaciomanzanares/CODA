...
function saldosDiariosRealesNoviembre(): CartolaParseResult["saldos_diarios"] {
  ...
  const pattern = [
    880681, 858391, 850000, 820000, 800000, 775000, 350000,
    19391,
    8500, 7200, 1243, 4627, 3627,
    15000, 16000, 17000, 18000, 20000, 22000, 28000, 32000, 35000, 38000, 42000, 48000, 52000, 58000, 62000,
    993680, 993680,
  ];
...
const CARTOLA_REAL: CartolaParseResult = {
  banco: "Santander",
  titular: "MANZANARES BANCHERO IGNACIO",
  cuenta: "0-011-00-55061-6",
  periodo: {
...
describe("scores con datos reales (Ignacio, noviembre 2025)", () => {
