...
import {
  listAlgorithmPredictionLogsForUser,
  exportPredictionLogsByDateRange,
...
export function registerAuditRoutes(app: Express): void {
  try {
     ...
     */
    app.get("/api/audit/my-predictions", authenticate, async (req: Request, res: Response) => {
     ...
     */
    app.get("/api/audit/prediction/:id", authenticate, async (req: Request, res: Response) => {
      const authReq = req as AuthenticatedRequest;
     ...
     */
    app.get("/api/audit/my-algorithm-logs", authenticate, async (req: Request, res: Response) => {
      const authReq = req as AuthenticatedRequest;
