...
const MERCHANT_RULES: MerchantRule[] = [
  ...
  {
    keywords: ["ok market", "minimarket", "big john", "oxxo", "express de lider"],
    category: "groceries",
    subcategory: "minimarket",
  },
  {
    keywords: ["feria", "verduleria", "carniceria", "panaderia"],
    category: "groceries",
    subcategory: "mercado",
  },
  ...
  {
    keywords: ["uber eats", "rappi", "pedidosya", "cornershop", "didi food"],
    category: "dining",
  ...
  // Transporte
  {
    keywords: ["uber", "didi", "cabify", "beat", "indriver"],
  ...
  {
    keywords: ["bip", "metro", "transantiago", "red", "microbus", "bus"],
    category: "transportation",
    subcategory: "transporte_publico",
  },
  {
    keywords: ["latam", "sky airline", "jetsmart", "avianca", "aeropuerto"],
    category: "travel",
    subcategory: "vuelos",
  },
  {
    keywords: ["estacionamiento", "parking", "autopista", "peaje", "tag"],
    category: "transportation",
    subcategory: "auto",
  },
  ...
  // Vivienda / Housing
  {
    keywords: ["arriendo", "alquiler", "renta", "inmobiliaria"],
    category: "housing",
    subcategory: "arriendo",
  },
  { keywords: ["dividendo", "hipotecario", "mutuo"], category: "housing", subcategory: "hipoteca" },
  {
    keywords: ["sodimac", "easy", "homecenter", "imperial", "construmart", "ferreteria"],
    category: "housing",
    subcategory: "hogar",
  },
  ...
  // Servicios / Utilities
  {
    keywords: ["enel", "chilquinta", "cge", "saesa", "electricidad", "luz"],
    category: "utilities",
    subcategory: "electricidad",
  },
  {
    keywords: ["aguas andinas", "esval", "nuevo sur", "agua"],
    category: "utilities",
    subcategory: "agua",
  },
  {
    keywords: ["metrogas", "gasco", "lipigas", "abastible", "gas"],
    category: "utilities",
    subcategory: "gas",
  },
  {
  ...
  {
    keywords: ["steam", "playstation", "xbox", "nintendo", "epic games", "riot"],
    category: "entertainment",
    subcategory: "gaming",
  },
  {
    keywords: ["cinemark", "cineplanet", "cinehoyts", "cine"],
    category: "entertainment",
    subcategory: "cine",
  },
  {
    keywords: ["gym", "smartfit", "pacific", "crossfit", "sportlife"],
    category: "entertainment",
    subcategory: "deporte",
  },
  ...
  // Shopping / Tiendas
  {
    keywords: ["falabella", "ripley", "paris", "la polar", "hites", "abcdin", "mall", "retail"],
    category: "shopping",
    subcategory: "tienda_departamental",
  },
  {
    keywords: ["aliexpress", "amazon", "mercadolibre", "mercado libre", "wish", "shein", "temu"],
    category: "shopping",
    subcategory: "online",
  },
  {
    keywords: ["nike", "adidas", "puma", "zara", "h&m", "uniqlo", "ropa", "calzado", "zapato"],
    category: "shopping",
    subcategory: "ropa",
  },
  {
    keywords: ["apple", "samsung", "huawei", "pcfactory", "sp digital", "tecnolog"],
    category: "shopping",
  ...
  // Salud / Healthcare
  {
    keywords: ["farmacia", "cruz verde", "salcobrand", "ahumada", "dr. simi"],
    category: "healthcare",
  ...
  {
    keywords: ["udemy", "coursera", "platzi", "domestika", "skillshare"],
    category: "education",
    subcategory: "cursos_online",
  },
  {
    keywords: ["libreria", "libro", "buscalibre", "antártica"],
    category: "education",
    subcategory: "libros",
  },
  ...
  // Viajes
  {
    keywords: ["hotel", "hostal", "airbnb", "booking", "despegar", "kayak", "trivago"],
    category: "travel",
  ...
  {
    keywords: ["transferencia", "tef", "traspaso"],
    category: "other",
    subcategory: "transferencia",
  },
  {
    keywords: ["cuota", "credito", "préstamo", "pago deuda"],
    category: "other",
    subcategory: "pago_credito",
  },
