...
export const SFA_PRODUCT_CODES: Record<string, SfaProductCode> = {
  ...
  A004: { code: 'A004', category: 'cuentas', subcategory: 'provision', name: 'Cuenta con provisión de fondos' },
  A005: { code: 'A005', category: 'cuentas', subcategory: 'ahorro', name: 'Cuenta de ahorro para la vivienda' },
  A006: { code: 'A006', category: 'cuentas', subcategory: 'ahorro', name: 'Cuenta de ahorro con giro diferido' },
  A007: { code: 'A007', category: 'cuentas', subcategory: 'ahorro', name: 'Cuenta de ahorro con giro incondicional' },
  ...
  C001: { code: 'C001', category: 'creditos', subcategory: 'consumo', name: 'Crédito en cuotas (no descuento planilla)' },
  C002: { code: 'C002', category: 'creditos', subcategory: 'consumo', name: 'Crédito en cuotas (descuento planilla)' },
  C003: { code: 'C003', category: 'creditos', subcategory: 'linea', name: 'Línea de crédito en cuenta corriente' },
  C004: { code: 'C004', category: 'creditos', subcategory: 'consumo', name: 'Otros créditos de consumo' },
  C005: { code: 'C005', category: 'creditos', subcategory: 'hipotecario', name: 'Hipotecario - letras de crédito' },
  C006: { code: 'C006', category: 'creditos', subcategory: 'hipotecario', name: 'Hipotecario - mutuo endosable' },
  C007: { code: 'C007', category: 'creditos', subcategory: 'hipotecario', name: 'Hipotecario - ANAP' },
  C008: { code: 'C008', category: 'creditos', subcategory: 'hipotecario', name: 'Hipotecario - mutuo no endosable' },
  C009: { code: 'C009', category: 'creditos', subcategory: 'hipotecario', name: 'Hipotecario - otros' },
  C010: { code: 'C010', category: 'creditos', subcategory: 'hipotecario', name: 'Bonos hipotecarios' },
  C011: { code: 'C011', category: 'creditos', subcategory: 'hipotecario', name: 'Créditos hipotecarios complementarios' },
  C012: { code: 'C012', category: 'creditos', subcategory: 'comercial', name: 'Créditos interbancarios' },
  C013: { code: 'C013', category: 'creditos', subcategory: 'comercial', name: 'Créditos comerciales' },
  ...
  C016: { code: 'C016', category: 'creditos', subcategory: 'comercial', name: 'Crédito hipotecario con fines generales' },
  C017: { code: 'C017', category: 'creditos', subcategory: 'estudiantil', name: 'Crédito estudiantil Ley 20.027' },
  C018: { code: 'C018', category: 'creditos', subcategory: 'estudiantil', name: 'Crédito estudiantil garantía CORFO' },
  C019: { code: 'C019', category: 'creditos', subcategory: 'estudiantil', name: 'Otros créditos estudiantiles' },

  // e) Instrumentos de ahorro o inversión
  E001: { code: 'E001', category: 'inversion', subcategory: 'deposito', name: 'Depósito a plazo fijo' },
  E002: { code: 'E002', category: 'inversion', subcategory: 'deposito', name: 'Depósito a plazo renovable' },
  E003: { code: 'E003', category: 'inversion', subcategory: 'deposito', name: 'Depósito a plazo indefinido' },
  E101: { code: 'E101', category: 'inversion', subcategory: 'fondos_mutuos', name: 'Fondo mutuo deuda ≤90d' },
  E102: { code: 'E102', category: 'inversion', subcategory: 'fondos_mutuos', name: 'Fondo mutuo deuda ≤365d' },
  E103: { code: 'E103', category: 'inversion', subcategory: 'fondos_mutuos', name: 'Fondo mutuo deuda mediano/largo plazo' },
  E104: { code: 'E104', category: 'inversion', subcategory: 'fondos_mutuos', name: 'Fondo mutuo mixto' },
  E105: { code: 'E105', category: 'inversion', subcategory: 'fondos_mutuos', name: 'Fondo mutuo capitalización' },
  E106: { code: 'E106', category: 'inversion', subcategory: 'fondos_mutuos', name: 'Fondo mutuo libre inversión' },

  // f) Tarjetas de pago
  F001: { code: 'F001', category: 'tarjetas', subcategory: 'pago', name: 'Operación de tarjetas de pago' },
};
