...
export const productCatalog: ProductCatalogItem[] = [
  ...
  // =============================================================================
  {
    ...
    description: 'Crédito rápido y flexible para cualquier necesidad. Aprobación en 24 horas con tasa preferente.',
  ...
  },
  {
    ...
    termUnit: 'meses',
    loanAmount: 8000000,
    description: '100% digital, sin papeleos. Ideal para proyectos personales y consolidación de deudas.',
    requirements: JSON.stringify([
  ...
  },
  {
    ...
    termUnit: 'meses',
    loanAmount: 3000000,
    description: 'Crédito personal con cuotas fijas y sin sorpresas. Perfecto para gastos imprevistos.',
    requirements: JSON.stringify([
  ...
  // =============================================================================
  {
    ...
    interestRate: 2.80, // 2.8% mensual ≈ 39% anual
    loanAmount: 2000000, // Línea de crédito
    description: 'Cashback 3% en supermercados y 2% en todo. Sin costo de mantención el primer año.',
    requirements: JSON.stringify([
      'Edad entre 18 y 70 años',
  ...
  // =============================================================================
  {
    ...
    description: 'Rentabiliza tus ahorros con tasa garantizada. Desde 90 días, renovación automática.',
    requirements: JSON.stringify([
  ...
  },
  {
    ...
    description: 'Protege tu hogar contra incendio, robo y responsabilidad civil. Cobertura de contenidos.',
    requirements: JSON.stringify([
  ...
  // =============================================================================
  {
    ...
    category: 'savings',
    monthlyPayment: 0,
    description: 'Cuenta vista sin mantención con tarjeta de débito Mastercard. Giros gratis en red propia.',
    requirements: JSON.stringify([
      'Mayor de 18 años',
      'Cédula de identidad',
      'Sin requisito de renta'
  ...
  // =============================================================================
  {
    ...
    category: 'loans',
    interestRate: 1.20, // 1.2% mensual UF
    term: 36,
    termUnit: 'meses',
    loanAmount: 20000000,
