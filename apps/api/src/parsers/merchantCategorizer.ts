...
const BRANCH_NOISE_RE = /\s+(?:PROV|SUC|SUCURSAL|LOCAL|MALL|STRIP\s?CENTER|PLAZA)\b.*$/;
...
export const TAXONOMY: Record<CategoryLabel, CategoryMeta> = {
  ...
  "Suscripciones y software": {
    ...
    variability: "fixed",
    excluded: false,
    legacy: "suscripciones",
  },
  Entretenimiento: {
    essential: false,
    variability: "variable",
    excluded: false,
    legacy: "entretenimiento",
  },
  "Retail y compras": {
    essential: false,
    variability: "variable",
...
const RULES: Rule[] = [
  ...
  {
    id: "cl.vivienda.condominio",
    category: "Vivienda",
    re: /\bCONDOMINIO\b|GASTOS?\s+COMUN/,
    subcategory: "Gastos comunes",
    confidence: 0.9,
    recurring: true,
  },
  {
    id: "cl.vivienda.coopeuch",
    category: "Vivienda",
    re: /\bCOOPEUCH\b/,
    subcategory: "Dividendo hipotecario",
    confidence: 0.9,
    recurring: true,
  },
  {
    id: "cl.vivienda.dividendo",
    category: "Vivienda",
    re: /\bDIVIDENDO\b|HIPOTECARIO|\bMUTUARIA\b/,
    subcategory: "Dividendo hipotecario",
    confidence: 0.92,
    recurring: true,
  },
  {
    id: "cl.vivienda.arriendo",
    category: "Vivienda",
    re: /\bARRIENDO\b|ARRENDAMIENTO/,
  ...
  // ── Seguros ───────────────────────────────────────────────────────────────
  {
    id: "cl.seguros",
    category: "Seguros",
    re: /\bSEGURO\b|\bPOLIZA\b|\bPRIMA\b|PAC\s+SEG|\bSEG\.?\s+FRAUDE\b|\bMAPFRE\b|\bSURA\b|\bMETLIFE\b|\bHDI\b|CONSORCIO|BICE\s+VIDA|CHILENA\s+CONSOLIDADA|\bZURICH\b|BCI\s+SEGUROS/,
    confidence: 0.88,
    recurring: true,
  },
  ...
  // ── Inversión y divisas ───────────────────────────────────────────────────
  {
    id: "cl.inversion.divisas",
    category: "Inversión y divisas",
    re: /\bAFEX\b|AGENTES?\s+DE\s+VAL|\bDIVISA(S)?\b|FONDO\s+MUTUO|\bFINTUAL\b|\bRACIONAL\b|CORREDORA\s+DE\s+BOLSA|CASA\s+DE\s+CAMBIO|\bAFP\b|\bAPV\b|DEP[O]?SITO\s+A\s+PLAZO|\bDAP\b/,
    confidence: 0.88,
  },
  ...
  // ── Suscripciones y software ──────────────────────────────────────────────
  {
    ...
    re: /NETFLIX|SPOTIFY|OPENAI|CHATGPT|ANTHROPIC|CLAUDE|\bHBO\b|DISNEY|PARAMOUNT|STAR\+|YOUTUBE\s*PREMIUM|AMAZON\s+PRIME|PRIME\s+VIDEO|\bAMZN\b|\bAMAZON\b|APPLE\.COM|ITUNES|ICLOUD|APPLE\s+MUSIC|\bADOBE\b|\bNOTION\b|\bCANVA\b|MICROSOFT|OFFICE\s?365|\bGITHUB\b|\bGOOGLE\b|DROPBOX|\bLINKEDIN\b|SUSCRIPCION|SUBSCRIPTION|\bSUBSCR\b|MEMBERSHIP|MEMBRESIA|\bPATREON\b/,
    confidence: 0.9,
    recurring: true,
  },
  ...
  // ── Entretenimiento ───────────────────────────────────────────────────────
  {
    id: "cl.entretenimiento",
    category: "Entretenimiento",
    re: /PLAY\s?STATION|\bXBOX\b|NINTENDO|\bSTEAM\b|EPIC\s+GAMES|\bRIOT\b|\bTWITCH\b|CINEMARK|CINE\s?HOYTS|\bHOYTS\b|CINEPOLIS|\bCINE\b|\bCINEMA\b|ENTERTAI|ENTERTAINMENT|\bTEATRO\b|CONCIERTO|\bGYM\b|GIMNASIO|SMART\s?FIT|\bPASS\s?LINE\b|PUNTO\s?TICKET|TICKETMASTER/,
    confidence: 0.88,
  },
  ...
  {
    id: "cl.restaurantes.delivery",
    category: "Restaurantes y delivery",
    re: /UBER\s*EATS|DIDI\s*FOOD|\bRAPPI\b|PEDIDOS\s?YA|\bIFOOD\b|JUST\s+EAT/,
  ...
  {
    id: "cl.servicios_basicos",
    category: "Servicios básicos",
    re: /\bENEL\b|\bCGE\b|CHILECTRA|\bSAESA\b|FRONTEL|CONAFE|AGUAS\s+ANDINAS|\bESVAL\b|\bESSBIO\b|AGUAS\s+DEL\s+VALLE|\bAGUAS\b|METROGAS|LIPIGAS|ABASTIBLE|\bGASCO\b|GAS\s+NATURAL|MOVISTAR|\bENTEL\b|\bWOM\b|\bVTR\b|\bCLARO\b|\bGTD\b|MUNDO\s+PACIFICO|INTERNET\s+HOGAR|FIBRA\s+OPTICA/,
    confidence: 0.9,
    recurring: true,
  },
  ...
  // ── Viajes ────────────────────────────────────────────────────────────────
  {
    id: "cl.viajes",
    category: "Viajes",
    re: /\bBOOKING\b|DESPEGAR|\bAIRBNB\b|TRIP\.COM|\bHOTEL\b|\bEXPEDIA\b|\bKAYAK\b/,
    confidence: 0.85,
  },
  ...
  // ── Educación ─────────────────────────────────────────────────────────────
  {
    id: "cl.educacion",
    category: "Educación",
    re: /UNIVERSIDAD|\bCOLEGIO\b|\bLICEO\b|\bDUOC\b|\bINACAP\b|\bCFT\b|PREUNIVERSITARIO|MATRICULA|\bARANCEL\b|JARDIN\s+INFANTIL|INSTITUTO\s+PROF|PONTIFICIA|\bESCUELA\b/,
    confidence: 0.88,
    recurring: true,
  },
