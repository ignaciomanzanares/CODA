...
const { createInscripcionJob, getInscripcionJob } =
  await import("../../src/services/assets/inscripcionJobs.js");
    ...
    h.rows = [
      {
        status: "done",
        message: null,
        result: JSON.stringify({ ok: true, prefill: { hasLien: true, lienAmountClp: 84999160 } }),
      },
    ];
