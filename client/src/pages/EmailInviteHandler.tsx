        ...
        if (finalResult.userExists) {
          ...
          if (isAuthenticated) {
            ...
            setTimeout(() => {
              loginWithRedirect({
                authorizationParams: {
                  login_hint: result.invitedEmail
                },
                appState: { 
                  targetUrl: `/bill-split?highlight=${billSplitId}`,
                  returnTo: `/bill-split?highlight=${billSplitId}`
                }
              });
  ...
  const handleSignUp = () => {
    if (checkResult) {
      loginWithRedirect({
        authorizationParams: {
          screen_hint: 'signup',
          login_hint: checkResult.invitedEmail
        },
        appState: { 
          targetUrl: `/bill-split?highlight=${checkResult.billSplitId}`,
          returnTo: `/bill-split?highlight=${checkResult.billSplitId}`
        }
      });
    }
  };
        ...
        <Card className="w-full max-w-md">
          <CardContent className="p-8 text-center">
            ...
            <p className="text-gray-600">
              {isRedirecting 
                ? 'You have a FinHealth account. Redirecting you to sign in...' 
      ...
      <Card className="w-full max-w-lg">
        ...
        <CardContent className="space-y-6">
          ...
          {checkResult.userExists ? (
            <div className="space-y-4">
              ...
              <p className="text-center text-gray-600">
                We found your FinHealth account for {checkResult.invitedEmail}. 
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-center space-x-2 text-blue-600">
                ...
                <span className="font-medium">New to FinHealth?</span>
              </div>
              <p className="text-center text-gray-600">
          ...
          <div className="bg-gray-50 p-4 rounded-lg">
            <h4 className="font-medium text-gray-900 mb-2">With a FinHealth account you can:</h4>
